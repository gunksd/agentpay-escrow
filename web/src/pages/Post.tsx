...
export default function Post() {
  const { address, busy, write, connect, notify } = useApp();
  ...
  return (
    <div className="page page-narrow">
      ...
      <p className="page-sub">
        The bounty leaves your wallet now and sits in escrow. It is released to the
        worker on approval (or timeout), or refunded to you if nobody claims in time.
      </p>
      ...
      <aside className="page-note">
        ...
        <ul>
          <li>
            <strong>Review window</strong>: after a submission, you have this long to
            approve or reject. Past it, the worker can force-settle and collect.
          </li>
          <li>
            <strong>Claimable for</strong>: if nobody claims before this deadline, you
            can cancel and the contract refunds the full bounty.
          </li>
          <li>
            <strong>Reject</strong> reopens the task for other workers and records a
            dispute against the worker's reputation.
          </li>
        </ul>
      </aside>
    </div>
